...
import {applicationRole, applicationRoleDefinition} from './application.characteristics';
import {cellRole, cellRoleDefinition} from './cell.characteristics';
import {columnheaderRole, columnheaderRoleDefinition} from './columnheader.characteristics';
import {comboboxRole, comboboxRoleDefinition} from './combobox.characteristics';
import {commandRole, commandRoleDefinition} from './command.characteristics';
import {compositeRole, compositeRoleDefinition} from './composite.characteristics';
import {contentinfoRole, contentinfoRoleDefinition} from './contentinfo.characteristics';
import {definitionRole, definitionRoleDefinition} from './definition.characteristics';
import {dialogRole, dialogRoleDefinition} from './dialog.characteristics';
import {directoryRole, directoryRoleDefinition} from './directory.characteristics';
import {documentRole, documentRoleDefinition} from './document.characteristics';
...
import {gridcellRole, gridcellRoleDefinition} from './gridcell.characteristics';
...
import {landmarkRole, landmarkRoleDefinition} from './landmark.characteristics';
...
import {listitemRole, listitemRoleDefinition} from './listitem.characteristics';
...
import {menuitemRole, menuitemRoleDefinition} from './menuitem.characteristics';
...
import {progressbarRole, progressbarRoleDefinition} from './progressbar.characteristics';
import {radioRole, radioRoleDefinition} from './radio.characteristics';
import {radiogroupRole, radiogroupRoleDefinition} from './radiogroup.characteristics';
...
import {roletypeRole, roletypeRoleDefinition} from './roletype.characteristics';
import {rowRole, rowRoleDefinition} from './row.characteristics';
import {rowgroupRole, rowgroupRoleDefinition} from './rowgroup.characteristics';
import {rowheaderRole, rowheaderRoleDefinition} from './rowheader.characteristics';
import {scrollbarRole, scrollbarRoleDefinition} from './scrollbar.characteristics';
import {searchRole, searchRoleDefinition} from './search.characteristics';
import {searchboxRole, searchboxRoleDefinition} from './searchbox.characteristics';
import {sectionRole, sectionRoleDefinition} from './section.characteristics';
import {sectionheadRole, sectionheadRoleDefinition} from './sectionhead.characteristics';
import {selectRole, selectRoleDefinition} from './select.characteristics';
import {separatorRole, separatorRoleDefinition} from './separator.characteristics';
import {sliderRole, sliderRoleDefinition} from './slider.characteristics';
import {spinbuttonRole, spinbuttonRoleDefinition} from './spinbutton.characteristics';
import {statusRole, statusRoleDefinition} from './status.characteristics';
import {structureRole, structureRoleDefinition} from './structure.characteristics';
...
import {tabpanelRole, tabpanelRoleDefinition} from './tabpanel.characteristics';
...
import {treegridRole, treegridRoleDefinition} from './treegrid.characteristics';
import {treeitemRole, treeitemRoleDefinition} from './treeitem.characteristics';
